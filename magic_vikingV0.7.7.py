...
class Equipment(pygame.sprite.Sprite):
    ...
    def __init__(self,name,p_img,inv_img,slash,smash,stab,fire,ice,thunder,dark,kind,weight,durability,description,blocks=True):
        ...
        self.value = (slash+smash+stab+fire+ice+thunder+dark)*2
                   ...
                   dist_to_player_y <= ((play_area_y*tile_height)/2):
                    if self.name == 'lych' and random.randint(1,10)>=6:
                        ...
                        if random_spell <= 2:
                            ...
                            self.cast_spell('thunder_spell',player.dest_x,player.dest_y)
                            
                    elif self.name == 'shaman' and random.randint(1,10)>2:
                        if random.randint(1,10)>= 7:
                            for m in monster_group:
                        ...
                        if self.name == "%s's minion"%player.name:
                            ...
                            for m in monster_group:
                                if m.name!= "%s's minion"%player.name:
                                    ...
                                    dist_to_monster_x = abs(self.map_x - m.map_x)
                                    dist_to_monster_y = abs(self.map_y - m.map_y)
                                    if dist_to_monster_x <= (play_area_x*tile_width) and \
                                        dist_to_monster_y <= (play_area_y*tile_height):
    ...
    def cast_spell(self,spell,coord_x,coord_y):
        ...
        if spell == 'heal_spell':
            ...
            if target is not None:
                ...
                dmg = (self.hit+random.randint(1,10))-(target.dodge+random.randint(1,10))
                if dmg <=0:
                    dmg =1
                target.hp -= dmg
    ...
    def death(self):
        ...
        if self == player:
            ...
            if len(loot_list) is not 0:
                loot = Treasure(self.map_x/tile_width,self.map_y/tile_height,corpse_img,loot_list,'Corpse',False)
...
def generate_equipment(cat=None):#generate an item at rect with category
    ...
    if monster_str <=3:
        ...
        if material_roll <= 3:
            ...
            c_name_2 = "Silk"
            p_name_2 = "Gold"
            min_quality = 3+monster_str
    
           
    quality_roll = random.randint(1,10)
    if monster_str <=3:
        if quality_roll<=9:
            max_quality = min_quality+monster_str
            name_1 = "Ruined"
        else:
            max_quality = min_quality+monster_str
            name_1 = "Common"
...
def create_epic_equipment():
    ...
    if equipment_roll <=15:
        item = Equipment('sword of sages',sword_img,equipment_wep_img,10+monster_str,0,10+monster_str,0,0,0,10+monster_str,'weapon',8,100,"an Ancient sword wielded by warrior monks")
        ...
        item = Equipment('lightning rod',staff_img,equipment_wep_img,10,10,10,0,0,10+monster_str,2,'weapon',8,100,"staff of the lightning god")
    else:
...
def create_rat_room(room):
    ...
    for i in range(0,max_monsters):
        ...
        if random_roll <= 100:
            ...
            per = 5+monster_str
            xp = 10+monster_str
            weapon = Equipment('teeth',no_equipment,equipment_wep_img,0,0,(2+monster_str),0,0,0,0,'wep',0,100,'teeth')
            armour = Equipment('fur',no_equipment,equipment_wep_img,0,0,0,(-7-monster_str),0,0,0,'wep',0,100,'fur')
...
def create_mixed_room(room):
    ...
    for i in range(max_monsters):
        ...
        if random_roll <= 30:
            ...
            per = 5+monster_str
            xp = 20+monster_str
            weapon = Equipment('bones spear',no_equipment,equipment_wep_img,(0),(0),(8+monster_str),0,0,0,(-5-monster_str),'wep',0,100,'bones')
            armour = Equipment('bones',no_equipment,equipment_wep_img,(5+monster_str),(-4-monster_str),(8+monster_str),0,(7+monster_str),0,(-5-monster_str),'armour',0,100,'bones')
            ...
            per = 5+monster_str
            xp = 20+monster_str
            weapon = Equipment('wand',no_equipment,equipment_wep_img,0,4+monster_str,0,0,(7+monster_str),(7+monster_str),(7+monster_str),'wep',0,100,'bones')
            armour = Equipment('bones',no_equipment,equipment_wep_img,(5+monster_str),(-4-monster_str),(8+monster_str),0,(7+monster_str),0,(-5-monster_str),'armour',0,100,'bones')
            ...
            xp = 30+monster_str
            weapon = Equipment('dagger',dagger_img,equipment_wep_img,4+monster_str,0,6+monster_str,0,0,0,0,'weapon',5,100,'')
            armour = Equipment('leather rags',leather_img,equipment_wep_img,1+monster_str,1+monster_str,1+monster_str,0,1+monster_str,1+monster_str,1+monster_str,'armour',5,100,'')
            ...
            xp = 50+monster_str
            weapon = Equipment('staff',dagger_img,equipment_wep_img,0,4+monster_str,0,5+monster_str,5+monster_str,5+monster_str,5+monster_str,'weapon',5,100,'')
            armour = Equipment('leather rags',leather_img,equipment_wep_img,1+monster_str,1+monster_str,1+monster_str,0,1+monster_str,1+monster_str,1+monster_str,'armour',5,100,'')
            ...
            xp = 50
            weapon = Equipment('sword',dagger_img,equipment_wep_img,8+monster_str,0,6+monster_str,0,0,0,0,'weapon',5,100,'')
            armour = Equipment('orc_armour',leather_img,equipment_wep_img,6+monster_str,6+monster_str,6+monster_str,0,1+monster_str,1+monster_str,1+monster_str,'armour',5,100,'')
...
def create_goblin_room(room):
    ...
    for i in range(0,max_monsters):
        ...
        if random_roll <= 80:
            ...
            xp = 30+monster_str
            weapon = Equipment('dagger',dagger_img,equipment_wep_img,1+monster_str,0,2+monster_str,0,0,0,0,'weapon',5,100,'')
            armour = Equipment('leather rags',leather_img,equipment_wep_img,1+monster_str,1+monster_str,1+monster_str,0,1+monster_str,1+monster_str,1+monster_str,'armour',5,100,'')
            ...
            xp = 50+monster_str
            weapon = Equipment('staff',dagger_img,equipment_wep_img,0,4+monster_str,0,2+monster_str,2+monster_str,2+monster_str,1+monster_str,'weapon',5,100,'')
            armour = Equipment('leather rags',leather_img,equipment_wep_img,1+monster_str,1+monster_str,1+monster_str,0,1+monster_str,1+monster_str,1+monster_str,'armour',5,100,'')
...
def create_orc_room(room):
    ...
    for i in range(0,max_monsters):
        ...
        if random_roll <= 80:
            ...
            xp = 150
            weapon = Equipment('club',dagger_img,equipment_wep_img,0,14+monster_str,0,0,0,0,0,'weapon',5,100,'')
            armour = Equipment('leather rags',leather_img,equipment_wep_img,9+monster_str,9+monster_str,9+monster_str,0,1+monster_str,1+monster_str,1+monster_str,'armour',5,100,'')
...
def create_final_boss(room):
    ...
    char = 0
    per = 0
    weapon = Equipment('fang',dagger_img,equipment_wep_img,0,0,25,0,0,0,0,'weapon',5,200,'Fang of the spider queen')
    armour = no_equipment
    xp = 70
...
def create_spider_room(room):
    ...
    for i in range(0,max_monsters):
        ...
        if random_roll <= 70:
            ...
            char = 0
            per = 0
            weapon = Equipment('fang',knife_img,equipment_wep_img,0,0,5,0,0,0,0,'dagger',5,100,'')
            armour = no_equipment
            xp = 20
            ...
            if bosses == 0:
                ...
                char = 0
                per = 0
                weapon = Equipment('fang',dagger_img,equipment_wep_img,0,0,15,0,0,0,0,'weapon',5,200,'Fang of the spider queen')
                armour = no_equipment
                xp = 70
...
def create_npc_room(room):
    ...
    for i in range(max_npc):
        ...
        armour = Equipment('Common Clothes',leather_img,equipment_wep_img,7,3,3,3,3,3,3,3,'armour',5,'')
        x = random.randint(room.x1+1,room.x2-2)
        y = random.randint(room.y1+1,room.y2-2)

        if not is_blocked(x,y):
            if not my_map[x][y].stairs_down:
                npc = Character(x,y,'Vendor',player_naked_img,3,3,1,1,3,2,30,random_char,random_per,no_equipment,armour,inventory,0)
                npc.modify_stats()
                npc_group.add(npc)
...
def load_new_level(state):
    ...
    if state == 'death':
        ...
        player = Character((play_area_x/2)*tile_width,(play_area_y/2)*tile_height,"Rahnook"\
            ,player_img,8,8,8,8,8,8,30,8,8,no_equipment,no_torso,[[silver_coin],[silver_coin],cash_bag,[bandage],[food],[pick]])
...
def make_village():
    ...
    magic_inventory = [[health,health,health,poison,poison,fire,fire,ice,ice,thun,thun,summon,tame,identify]]
    coin_inv = []
    epic_inv = []
    ...
    baker_npc = Character(6,6,'Baker',player_naked_img,3,3,1,1,3,2,30,13,8,no_equipment,no_equipment,bakery_inv,0)
    baker_npc.modify_stats()
    npc_group.add(baker_npc)
    weapon_npc = Character(13,6,'Weapon Smith',player_naked_img,3,3,1,1,3,2,30,17,8,no_equipment,no_equipment,weapon_inv,0)
    weapon_npc.modify_stats()
    npc_group.add(weapon_npc)
    armour_npc = Character(15,6,'Weapon Smith',player_naked_img,3,3,1,1,3,2,30,17,8,no_equipment,no_equipment,armour_inv,0)
    armour_npc.modify_stats()
    npc_group.add(armour_npc)
    scribe_npc = Character(17,15,'Scribe',player_naked_img,3,3,1,1,3,2,30,17,8,no_equipment,no_equipment,magic_inventory,0)
    scribe_npc.modify_stats()
    npc_group.add(scribe_npc)
    magister_npc = Character(17,12,'Magister',player_naked_img,3,3,1,1,3,2,30,37,8,no_equipment,no_equipment,epic_inv,0)
...
def calc_field_of_view():
    ...
    for y in range ((player.map_y-100)/tile_width,(player.map_y+200)/tile_width):
        for x in range ((player.map_x-100)/tile_width,(player.map_x+200)/tile_width):
            ...
            #upper left
            if x*tile_width < player.map_x and y*tile_height < player.map_y and my_map[x][y].block_sight == False:
...
def render_all():
    ...
    for m in monster_group:
        if m.frozen:
            if len(effect_group)<=0:
                screen.blit(ice_3,(m.rect.x,m.rect.y))
    ...
    if player.gloves.player_img is not None:
        screen.blit(player.gloves.player_img,(player.rect.x,player.rect.y))
...
cash_bag = []
for i in range(1,51):
    starter_cash = Item('Gold Coin','currency',50,gold_coin_img,0.1)
...
player = Character((play_area_x/2)*tile_width,(play_area_y/2)*tile_height,"Rahnook"\
            ,player_img,8,8,8,8,8,8,30,8,8,no_equipment,no_torso,[[silver_coin],[silver_coin],[test_fire],[test_fire],[test_fire],[test_fire],cash_bag,[bandage],[food],[pick]])
