...
def load_new_level(state):
    ...
    if state == 'death':
        ...
        max_monsters = 3
        monster_str = 1
        player = Character((play_area_x/2)*tile_width,(play_area_y/2)*tile_height,"Rahnook",player_naked_img,8,8,8,8,8,8,100,8,8,8,None,None,[starter_cash,copper_key])
...
def make_dungeon():
    ...
    global my_map
    max_features = 200#random.randint(50,400)
    max_halls = 7
    halls = 0
    max_exits = 1
    exits = 0
