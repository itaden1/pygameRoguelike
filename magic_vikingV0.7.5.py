...
stats_gui = pygame.Surface((3*tile_width,3*tile_height))
...
class Character(pygame.sprite.Sprite):
    ...
    def __init__(self,x,y,name,img,attk,de,m_attk,m_de,hit,dodge,hp,cha,per,wep,arm,inventory,xp=None,blocks=True):
        ...
        self.max_weight = 20 #based on strength
...
def generate_item():
    ...
    if random_roll <= 10:
        item = Item('Health Scroll','scroll',30,scroll_img,2)

    elif random_roll <= 20:
        item = Item('Fire Scroll','scroll',30,scroll_img,2)

    elif random_roll <= 30:
        item = Item('Ice Scroll','scroll',30,scroll_img,2)

    elif random_roll <= 31:
        item = Item('Copper Key','key',1,key_img,2)
        
    elif random_roll <= 90:
        item = Item('Anti Venom','potion',20,potion_img,3)
    else:
        item = Item('Linen Bandage','bandage',10,scroll_img,2)
    return item
...
def calc_field_of_view():
    ...
    for y in range (tiles_y):#((player.map_y-200)/tile_width,(player.map_y+300)/tile_width):
        for x in range (tiles_x):#((player.map_x-200)/tile_width,(player.map_x+300)/tile_width):
            my_map[x][y].explored = True
...
floor_b_img = pygame.image.load('floor_1.png')
